...
def evaluate(encoder, val_dl, criterion, config):
    val_loss = 0
    step = 0
    ...
    while step < config.num_steps:
        ...
        for batch in pbar:
            ...
            if step % config.eval_every == 0:
                ...
                val_loss = evaluate(encoder, val_dl, criterion, config)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="results/contrast_baseline_TC")
